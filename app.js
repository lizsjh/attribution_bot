...
botui.message.add({
    ...
    return botui.message.add({
        delay:900,
        loading: true,
        content:'I do not understand what you said because my ability to process the message is not perfect. Can you try again?'
    });
}).then(function(){
    return botui.action.text({
        action: {
    ...
    return botui.message.add({
        delay:900,
        loading: true,
        content:'I can`t process your message. I lack the ability to fully understand your message. Please type again.'
    });
}).then(function(){
    return botui.action.text({
        action: {
    ...
    return botui.message.add({
        delay:900,
        loading: true,
        content:'I cannot understand because I am not fully capable of interpreting the message. Can you repeat?'
    });
}).then(function(){
    return botui.action.text({
        action: {
